(() => {
    ...
    window.onload = function() {
        ...
        const hoverBgBar = document.querySelectorAll(".menu__item");
        hoverBgBar.forEach((itemBG => {
            itemBG.addEventListener("mouseenter", (function(e) {
                document.querySelector(".wrapper").classList.add("_opacity");
            }));
            itemBG.addEventListener("mouseleave", (function(e) {
                document.querySelector(".wrapper").classList.remove("_opacity");
            }));
        }));
    };
    window["FLS"] = true;
